...
current_preds <- insight::find_predictors(mod, effects = "fixed", component = "conditional")$conditional |> setdiff(insight::find_offset(mod)) 
```
...
mod_dharma <- DHARMa::simulateResiduals(mod, n = 50, plot = FALSE)
