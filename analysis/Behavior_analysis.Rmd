...
(behavior_pups_data <- load_behavior_pups() |> 
  mutate(
    Day = center(Day),
...
(behavior_teens_data <- load_behavior_teens())
...
(behavior_adults_Morris_data <- load_behavior_adults(sheet = "Behavior") |> 
  mutate(
    Stage = factor(Stage),
...
(behavior_adults_combined_data <- purrr::reduce(
  .x = purrr::map(combined_sheets, .f = \(sheet) load_behavior_adults(sheet = sheet)),
...
```{r fig.width = 2, fig.height = 3}
(make_signif_boxplot(behavior_adults_mod_PDT, xaxis = "Condition") + scale_y_continuous(labels = scales::percent)) |> 
...
```{r fig.width = 2, fig.height = 3}
(make_signif_boxplot(behavior_adults_mod_PTT, xaxis = "Condition") + scale_y_continuous(labels = scales::percent))|> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_AMS, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_AD, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_CT, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_NM, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_ORT, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_OGT, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_POT, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_PCT, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_NEO, xaxis = "Condition") |> 
...
```{r fig.width = 2, fig.height = 3}
make_signif_boxplot(behavior_adults_mod_NEC, xaxis = "Condition") |> 
